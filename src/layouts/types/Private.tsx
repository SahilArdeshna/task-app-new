...
import { ROUTE_LOGIN, ROUTE_PROFILE, ROUTE_TASKS } from "../../utils/constants";
              ...
              <div className="relative flex h-16 items-center justify-between">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  ...
                  <Menu as="div" className="relative ml-3">
                    <div>
                      <Menu.Button className="flex items-center rounded-md bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 focus:ring-offset-gray-800 p-2">
                        ...
                        {/* hidden lg:block */}
                        <Icon
                          appendClass="flex-shrink-0 ml-1 h-4 w-4 text-gay-300 block"
                          removeClass="h-5 w-5"
                        >
